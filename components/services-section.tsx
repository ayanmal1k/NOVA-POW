  ...
  return (
    <section id="services" className="relative w-full overflow-hidden bg-[#080604] text-white py-20 md:py-28 lg:py-32">
      ...
      <div className="relative z-10 w-full px-6 sm:px-10 md:px-16 lg:px-20 xl:px-24">
        ...
        {/* ── Services Layout: 3 in First Row, 2 Centered in Second Row Across Full Width ── */}
        <motion.div
        ...
        >
          ...
          {/* Row 2: 2 Cards Centered Across Full Width */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:flex lg:justify-center gap-6 sm:gap-8 w-full">
